...
def setup_cognito_user_pool():
    ...
    try:
        ...
        user_pool_response = cognito_client.create_user_pool(
            PoolName='mortgage-assistant-inbound-cognito-userpool',
            Policies={
                'PasswordPolicy': {
                    'MinimumLength': 8
                }
        ...
        app_client_response = cognito_client.create_user_pool_client(
            UserPoolId=pool_id,
            ClientName='InboundCognitoUserPoolClient',
...
def reauthenticate_user(client_id):
    ...
    bearer_token = auth_response['AuthenticationResult']['AccessToken']
    return bearer_token
    # client_secret = get_ssm_parameter("/app/mortgageagent/agentcore/client_secret")
    # secret_hash = calculate_secret_hash('testuser', client_id, client_secret)
    ...
    role_policy = {
        ...
        "Statement": [
            ...
            },
            {
                ...
                "Resource": f"arn:aws:bedrock:*:{account_id}:knowledge-base/*"
            },
            {
                "Effect": "Allow",
                "Action": [
                ...
                "Resource": [
                    f"arn:aws:ssm:{region}:{account_id}:parameter/app/*"
                ]
            }
        ]
    }
...
def create_gateway_lambda(lambda_function_code_path) -> dict[str, int]:
    ...
    role_arn = ''
    lambda_function_name = 'creditcheck_lambda'
